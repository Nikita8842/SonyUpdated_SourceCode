...
{
    public class ReportQSRQuantity : MasterAbstract
    {
    ...
    public class QsrReportsGrid : ReportQSRQuantity
    {
    ...
    public class QSRQuantityGet : ReportQSRQuantity
    {
        public string TargetDate { get; set; }//
        public Int64 BranchId { get; set; }//
        public string Branch { get; set; }
        public QSRQuantityUpload QSRQuantityUpload { get; set; }
    }
    ...
    public class QSRQuantityReportUploadOutput
    {
        public string BranchName { get; set; }
        public string Date { get; set; } //nikita 20/11/2024
        public string DealerName { get; set; } //nikita 20/11/2024
        public string City { get; set; }
        public string Location { get; set; }
        public string SFACode { get; set; }
        public string SFAName { get; set; }
