...
namespace AmboLibrary.GlobalAccessible
{
    /// <summary>
    ...
    {
        public IEnumerable<CityTypeMaster> TypeList { get; set; }
    }
    ...
    public class CompetitorsList : MasterAbstract
    {
        public override Int64 UserId { get; set; }
        public override string EncryptKey { get; set; }
        public override string RoleName { get; set; }
        public IEnumerable<Competitors> Competitors { get; set; }
    }
    ...
    public class CompetitorProductsList : MasterAbstract
    {
        public override Int64 UserId { get; set; }
        public override string EncryptKey { get; set; }
        public override string RoleName { get; set; }
        public IEnumerable<CompetitorProducts> CompetitorProducts { get; set; }
    }
    ...
    public class MaterialsList : MasterAbstract
    {
        public override Int64 UserId { get; set; }
        public override string EncryptKey { get; set; }
        public override string RoleName { get; set; }
