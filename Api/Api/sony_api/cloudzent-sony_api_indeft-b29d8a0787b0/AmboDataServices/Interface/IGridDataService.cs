...
namespace AmboDataServices.Interface
{
    public interface IGridDataService
    {
        ...
        BroadcastMessageEDITData BroadcastMessageMasterGridBYID(BMessageInputModel objGridVariables);        
        ...
        TrainingMasterEditData TrainingDataBYID(TInputModel objGridVariables);
